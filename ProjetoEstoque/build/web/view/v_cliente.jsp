            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <span class="section">Informações de Clientes</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nome">Nome Cliente<span class="required">*</span>
                        </label>
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="cpf_cnpj" id="cpf_cnpj" name="cpf_cnpj" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="uf">UF<span class="required">*</span>    
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="uf" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="uf" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bairro">Bairro<span class="required">*</span>    
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="bairro" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="bairro" required="required" type="text">
                        </div>
                      </div>
